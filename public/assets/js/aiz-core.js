                ...
                $(".aiz-count-down").each(function () {
                    ...
                    $this.countdown(date).on("update.countdown", function (event) {
                        var $this = $(this).html(
                            event.strftime(
                                "" +
                                    '<span class="countdown-separator font-weight-bold ">D:</span><div class="countdown-item"><span class="countdown-digit">%-D</span></div>' +
                                    '<span class="countdown-separator font-weight-bold ">H:</span><div class="countdown-item"><span class="countdown-digit">%H</span></div>' +
                                    '<span class="countdown-separator font-weight-bold ">M:</span><div class="countdown-item"><span class="countdown-digit">%M</span></div>' +
                                    '<span class="countdown-separator font-weight-bold ">S:</span><div class="countdown-item"><span class="countdown-digit">%S</span></div>'
                            )
                        );
                    });
