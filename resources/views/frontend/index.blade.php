        ...
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                    ...
                    <div class="aiz-count-down ml-auto ml-lg-3 align-items-center mb-1" data-date="{{ date('Y/m/d H:i:s', $flash_deal->end_date) }}"></div>
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                    @foreach ($flash_deal->flash_deal_products as $key => $flash_deal_product)
                        ...
                        @if ($product != null && $product->published != 0)
                            <div class="carousel-box">
                                <div class="aiz-card-box border border-gray-800 border-secondary rounded hov-shadow-md my-2 has-transition">
                                    <div class="position-relative">
                                        <a href="{{ route('product', $product->slug) }}" class="d-block">
                                            <img
                                                ...
                                                alt="{{  $product->getTranslation('name')  }}"
                                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';"
                                                style="border-bottom: 1px solid #585859"
                                            >
                                        </a>
                                        <div class="absolute-top-right aiz-p-hov-icon d-flex">
                                    ...
                                    <div class="p-md-2 p-2 text-left">
                                        ...
                                        <div class="rating rating-sm mt-1 fs-10">
                                        ...
                                        <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-40px">
                                            <a href="{{ route('product', $product->slug) }}" class="d-block text-reset">{{  $product->getTranslation('name')  }}</a>
                                        </h3>
                                        <div class="fs-18">

                                            <span class="fw-700 text-success">{{ home_discounted_base_price($product->id) }}</span>
                                            @if(home_base_price($product->id) != home_discounted_base_price($product->id))
                                                <del class="fw-600 opacity-75 mr-1 fs-13 text-primary">{{ home_base_price($product->id) }}</del>
                                            @endif
                                        </div>
...
{{--                                <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('Top 10 Brands') }}</span>--}}
                                <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">Shop By Brand</span>
                            </h3>
